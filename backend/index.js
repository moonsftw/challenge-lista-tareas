...
// Array en momemoria como almacenamiento temporal
let tareas = [];
let idActual = 1;
...
app.post('/api/tasks', (req, res) => {
  ...
  const nuevaTarea = { id: idActual++, titulo, desc, completed: false, creada: new Date().toLocaleString("es-AR", {year: "numeric", month: "2-digit", day:"2-digit", hour:"2-digit", minute:"2-digit"}) };
...
app.put('/api/tasks/:id', (req, res) => {
  ...
  tareas[tareaIndex] = {
    ...
    creada: tareas[tareaIndex].creada // Mantener la fecha de creación original
  };
